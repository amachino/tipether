...
exports.ParserRules = [
    ...
    { "name": "TipCommand", "symbols": ["_", { "literal": "tip" }, "__", "Username"], "postprocess": d => ({ type: parser_1.CommandType.TIP, username: d[3] }) },
    { "name": "TipCommand", "symbols": ["TipCommand", "_", "Amount"], "postprocess": d => Object.assign(d[0], d[2]) },
    { "name": "WithdrawCommand", "symbols": ["_", { "literal": "withdraw" }, "__", "Amount", "__", "Address"], "postprocess": d => Object.assign({ type: parser_1.CommandType.WITHDRAW, address: d[5] }, d[3]) },
    { "name": "DepositCommand", "symbols": ["_", { "literal": "deposit" }], "postprocess": d => ({ type: parser_1.CommandType.DEPOSIT }) },
    { "name": "BalanceCommand", "symbols": ["_", { "literal": "balance" }], "postprocess": d => ({ type: parser_1.CommandType.BALANCE }) },
    { "name": "HelpCommand", "symbols": ["_", { "literal": "help" }], "postprocess": d => ({ type: parser_1.CommandType.HELP }) },
